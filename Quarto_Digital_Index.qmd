...
5.  I have used the municipal website for other purposes (use_other). Each of these questions was measured as a dummy variable, coded as 1 for "yes" and 0 otherwise.
...
EOP_nona <- na.omit(EOP[c("ope1", "ope2", "ope3", "ope4", "dig_mun", "ingresos","log_ingresos_real", "sex", "age", "SES", "education", "polint1", "polint2", "polint3", "polint4", "polint5", "year", "useweb_nona", "useadm_nona", "useinfo_nona", "usetransp_nona", "useother_nona")])
...
fit_cfa3 <- cfa(cfa.model3, data = EOP_nona)
...
modelk_nona <- lm(use ~ dig_mun + ingresos + sex + age + SES + education + ope1 + intpol + factor(year), data = EOP_nona)
summary(modelk_nona)
```
...
## Testing with real income 2018-2023

```{r}
modela_mean <- lm(ope ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + factor(year), data = EOP_nona)
summary(modela_mean)

modelb_mean <- lm(ope1 ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + factor(year), data = EOP_nona)
summary(modelb_mean)

modelc_mean <- lm(ope2 ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + factor(year), data = EOP_nona)
summary(modelc_mean)

modeld_mean <- lm(ope3 ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + factor(year), data = EOP_nona)
summary(modeld_mean)

modele_mean <- lm(ope4 ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + factor(year), data = EOP_nona)
summary(modele_mean)
```

```{r}
modelf_nona_real <- glm(useweb_nona ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + factor(year), data = EOP_nona, family = binomial)
summary(modelf_nona_real)

modelg_nona_real <- glm(useadm_nona ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + factor(year), data = EOP_nona, family = binomial)
summary(modelg_nona_real)

modelh_nona_real <- glm(useinfo_nona ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + factor(year), data = EOP_nona, family = binomial)
summary(modelh_nona_real)

modeli_nona_real <- glm(usetransp_nona ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + factor(year), data = EOP_nona, family = binomial)
summary(modeli_nona_real)

modelj_nona_real <- glm(useother_nona ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + factor(year), data = EOP_nona, family = binomial)
summary(modelj_nona_real)

modelk_nona_real <- lm(use ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + factor(year), data = EOP_nona)
...
modela_pan_int1 <- lm(ope ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + post_pandemic + log_ingresos_real * post_pandemic , data = EOP_nona)
summary(modela_pan_int1)

modela_pan_int2 <- lm(ope ~ dig_mun + log_ingresos_real + sex + age + SES + education + intpol + post_pandemic + dig_mun * post_pandemic , data = EOP_nona)
...
modela_pan_int3 <- lm(use ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + post_pandemic + log_ingresos_real * post_pandemic , data = EOP_nona)
summary(modela_pan_int3)

modela_pan_int4 <- lm(use ~ dig_mun + log_ingresos_real + sex + age + SES + education + ope + intpol + post_pandemic + dig_mun * post_pandemic , data = EOP_nona)
